...
console.log('odd nums: ', nums)    
console.log('even nums: ', evensArr)
...
/* The famous FizzBuzz, Devmountain style!
  ...
  using some conditional logic, if the number your for loop is currently on is divisible by 3, 
  console.log 'Dev'. If the number is divisible by 5, console.log 'mountain'. If the number is divisible 
  by 5 & 3, console.log 'Devmountain'. If the number is not divisible by 5 or 3, console.log the number itself. 
...
//Code Here
// if divisible by 3, log dev, if divisible by 5, log mountain, if divisible by both, log devmountain, if none log the number
for (let i = 1; i <= 100; i++)
if(i % 3 === 0 && i % 5 === 0){
